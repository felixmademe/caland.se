...
@section( 'content' )
    ...
    <section class="staff">
        ...
        <div class="row row-eq-height">
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/johan.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/reimond.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/henrik.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/lars.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/marcus.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/robin.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/lena.jpg' ) }}" data-toggle="lightbox">
            ...
            <div class="col-md-6">
                <a rel="noopener noreferrer" href="{{ asset( '/img/staff/charlotta.jpg' ) }}" data-toggle="lightbox">
